...
本项目是一个典型的 CRUD（增删改查）应用，业务逻辑直观清晰，采用 Spring Boot + MyBatis-Plus 技术栈构建后端服务，提供完整的二手交易功能。系统支持用户注册登录、商品发布、商品浏览、搜索过滤、留言评论等核心功能。
...
### 前端技术（推荐）
- **小程序**: 微信小程序原生开发
- **Web应用**: Vue 3 + Element Plus / React + Ant Design
- **移动端**: uni-app 跨平台开发
...
- API 文档: http://localhost:8080/swagger-ui.html（需集成 Swagger）
